...
public class GoalManager {
    ...
    private Goal generateRandom(int turn) {
        ...
        if (rand == 1) {
            ...
            double lowerBound = Math.floor(expectedTurns - 0.25 * expectedTurns); //These two variables are bounds for the generation of a suitable forTurns variable.
            double upperBound = Math.ceil(expectedTurns + 0.25 * expectedTurns);
